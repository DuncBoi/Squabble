...
class CreateTopic : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val topicsRef = FirebaseDatabase.getInstance().reference.child("Topics").child(args.topic)
        topicsRef.onDisconnect().cancel()
            ...
            b_create_topic_create.setOnClickListener {
                if (et_create_topic_headline.text.toString()
                    ...
                    val id = FirebaseDatabase.getInstance().reference.child("Topics").push().key
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                val filePath = storageReference.child("$currentUser").child("$key")
